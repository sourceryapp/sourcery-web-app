    ...
    <div id="public-layout">
        <v-app>
            <BannersPurpleCallout :show="isHome && headerIntersectStore.headerIntersect">
                <p class="text-white mb-0">We're hiring Community &amp; Research Ambassadors in New York City. For more information, visit our <NuxtLink to="ambassadors" class="text-white">ambassadors page</NuxtLink>!</p>
