            ...
            <v-row class="mb-2">
                ...
                <v-col cols="12" md="6">
                    <v-item-group class="d-flex justify-space-between ga-3 fill-height">
                        <v-item>
                            <v-card width="100%" @click="setStatus('STATUS_CREATED')" link class="fill-height">
                            ...
                            <v-card width="100%" @click="setStatus('STATUS_PAID')" link class="fill-height">
                            ...
                            <v-card width="100%" @click="setStatus('STATUS_COMPLETED')" link class="fill-height">
