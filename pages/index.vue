      ...
      <div class="section-container">
        ...
        <div class="feature">
          ...
          <div class="feature-desc">
            ...
            <p class="feature-text">
              Request a document using just a citation and where it’s located.
            </p>
          </div>
        </div>
        <div class="feature feature__text-first">
          ...
          <div class="feature-desc">
            ...
            <p class="feature-text">
              Receive high resolution scans from institutions and Sourcery-registered researchers.
            </p>
          </div>
        </div>
        <div class="feature">
          ...
          <div class="feature-desc">
            ...
            <p class="feature-text">
              Give archival staff and patrons one easy platform for requesting and receiving scans.
            </p>
          </div>
        </div>
        <div class="feature feature__text-first">
          ...
          <div class="feature-desc">
            ...
            <p class="feature-text">
              Save your wallet from expensive flights and transportation.
            </p>
          </div>
        </div>
        <div class="feature">
          ...
          <div class="feature-desc">
            ...
            <p class="feature-text">
              Gain efficient, affordable
              access with Sourcery.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="section-container">
        ...
        <div class="paragraphs">
          <p class="medium">
            ...
            <span>send it directly to your desktop or mobile device</span>.
          </p>
          ...
          <p class="text indiv">
            ...
            other cities).
            <span>Just provide the document’s citation information, and
