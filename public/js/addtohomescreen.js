...
*/
    ...
    _extend(ath, {
        ...
        isMobileChrome: _ua.includes('Android') && (/Chrome\/[.0-9]*/).test(_ua) && !_ua.includes('Version'),
        isMobileIE: _ua.includes('Windows Phone'),
    ...
    ath.isMobileSafari = ath.isIDevice && _ua.includes('Safari') && !_ua.includes('CriOS')
    ...
    ath.isTablet = (ath.isMobileSafari && _ua.includes('iPad')) || (ath.isMobileChrome && !_ua.includes('Mobile'))
    ...
    // event type to method conversion
        ...
        show (force) {
            ...
            const now = Date.now()
            const lastDisplayTime = this.session.lastDisplayTime
